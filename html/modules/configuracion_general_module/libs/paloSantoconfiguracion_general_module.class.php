...
class paloSantoconfiguracion_general_module
{
    ...
    function getconfiguracion_general2MariaDB()
    {
        ...
        if ($result == FALSE) {
            $this->errMsg = $this->_DB->errMsg;
            insertLogToDB($this->_DB->errMsg, "Conexiones_bd", "Error", "getconfiguracion_general2MariaDB"); 
            return null;
        }
        return $result;
    }
    ...
    function updateconfiguracion_general2MariaDB($data)
    {
        ...
        if ($this->_DB->genQuery($sPeticionSQL)) {
            ...
            $this->errMsg = $this->_DB->errMsg;
            insertLogToDB($this->_DB->errMsg, "Conexiones_bd", "Error", "updateconfiguracion_general2MariaDB"); 
        }
